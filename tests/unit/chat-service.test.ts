...
import { createChatService, type SendResult } from '../../src/server/chat/chat-service';
...
import { aPlanWithShopping } from '../support/a-chat-plan';
...
function aChatRig(options: { readonly plan?: PlanView } = {}) {
...
type Rig = ReturnType<typeof aChatRig>;
